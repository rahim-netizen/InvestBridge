// React Bits "GradientText" — an animated, sweeping gradient fill for text.
// Uses the project's existing framer-motion dependency (API-compatible with
// the upstream "motion/react" import the component ships with).
